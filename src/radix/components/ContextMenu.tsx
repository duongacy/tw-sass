...
interface RadixContextMenuProps
  extends ContextMenu.ContextMenuProps {}

export const RadixContextMenu: React.FC<
  RadixContextMenuProps
> = (props) => {
  ...
  return (
    <ContextMenu.Root {...props}>
      <ContextMenu.Trigger className='block w-[300px] select-none rounded  border-2 border-dashed border-white py-[45px] text-center text-[15px]'>
        Right click here.
      </ContextMenu.Trigger>
      <ContextMenu.Portal>
        <ContextMenu.Content className='min-w-[220px] overflow-hidden rounded-md bg-white p-[5px] shadow-[0px_10px_38px_-10px_rgba(22,_23,_24,_0.35),_0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)]'>
          ...
          <ContextMenu.Sub>
            <ContextMenu.SubTrigger className='group relative flex h-[25px] select-none items-center rounded-[3px] px-[5px] pl-[25px] text-[13px] leading-none text-violet11 outline-none data-[disabled]:pointer-events-none data-[highlighted]:bg-violet9 data-[highlighted]:data-[state=open]:bg-violet9 data-[state=open]:bg-violet4 data-[disabled]:text-mauve8 data-[highlighted]:data-[state=open]:text-violet1 data-[highlighted]:text-violet1 data-[state=open]:text-violet11'>
              More Tools
              <div className='ml-auto pl-5 text-mauve11 group-data-[disabled]:text-mauve8 group-data-[highlighted]:text-white'>
                <ChevronRightIcon />
              </div>
            ...
            <ContextMenu.Portal>
              ...
              >
                ...
                <ContextMenu.Item className='relative flex h-[25px] select-none items-center rounded-[3px] px-[5px] pl-[25px] text-[13px] leading-none text-violet11 outline-none data-[disabled]:pointer-events-none data-[highlighted]:bg-violet9 data-[disabled]:text-mauve8 data-[highlighted]:text-violet1'>
                  Create Shortcut…
                </ContextMenu.Item>
                <ContextMenu.Item className='relative flex h-[25px] select-none items-center rounded-[3px] px-[5px] pl-[25px] text-[13px] leading-none text-violet11 outline-none data-[disabled]:pointer-events-none data-[highlighted]:bg-violet9 data-[disabled]:text-mauve8 data-[highlighted]:text-violet1'>
                  Name Window…
