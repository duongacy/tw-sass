  ...
  return (
    <section
      className={clsx(
        ...
        featured
          ? 'order-first bg-primary-600 py-8 lg:order-none'
          : 'lg:py-8'
      )}
    >
      <h4 className='mt-5 font-display text-white'>
        {name}
      </h4>
      <p
        className={clsx(
    ...
    >
      <Container className={undefined}>
        <div className='md:text-center'>
          ...
          <h4 className='mt-4 text-secondary-400'>
            It doesn’t matter what size your business is,
            our software won’t work well for you.
          </h4>
        </div>
