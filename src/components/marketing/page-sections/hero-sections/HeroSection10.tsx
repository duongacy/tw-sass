...
export const HeroSection10: FC<HeroSectionProps> = ({
  className = '',
  ...props
}) => {
  return (
        ...
        <div className='px-6 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6'>
          <div className='mx-auto max-w-2xl lg:mx-0'>
            ...
            <div className='hidden sm:mt-32 sm:flex lg:mt-16'>
              <div className='relative rounded-full px-3 py-1 text-sm leading-6 text-neutral-500 ring-1 ring-neutral-900/10 hover:ring-neutral-900/20'>
            ...
            <h1 className='mt-24 text-4xl font-bold tracking-tight text-neutral-900 sm:mt-10 sm:text-6xl'>
