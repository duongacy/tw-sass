...
> = ({ className, ...props }) => {
  return (
    <div
      className={`relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8 ${className}`}
      {...props}
    >
      ...
      <div className='mx-auto max-w-2xl lg:max-w-4xl'>
        ...
        <figure className='mt-10'>
          <blockquote className='text-center text-xl font-semibold leading-8 text-neutral-900 sm:text-2xl sm:leading-9'>
            <p>
