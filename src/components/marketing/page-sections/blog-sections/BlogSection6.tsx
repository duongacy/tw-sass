      ...
      <div className='mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-12 px-6 sm:gap-y-16 lg:grid-cols-2 lg:px-8'>
        <article className='mx-auto w-full max-w-2xl lg:mx-0 lg:max-w-lg'>
          ...
          <div className='mt-4 flex flex-col justify-between gap-6 sm:mt-8 sm:flex-row-reverse sm:gap-8 lg:mt-4 lg:flex-col'>
            ...
            <div className='flex lg:border-t lg:border-neutral-900/10 lg:pt-8'>
              <a
                href={featuredPost.author.href}
                className='flex gap-x-2.5 text-sm font-semibold leading-6 text-neutral-900'
              >
                <img
        ...
        <div className='mx-auto w-full max-w-2xl border-t border-neutral-900/10 pt-12 sm:pt-16 lg:mx-0 lg:max-w-none lg:border-t-0 lg:pt-0'>
          <div className='-my-12 divide-y divide-neutral-900/10'>
            {posts.map((post) => (
              <article key={post.id} className='py-12'>
                <div className='group relative max-w-xl'>
                  ...
                  <h2 className='mt-2 text-lg font-semibold text-neutral-900 group-hover:text-neutral-600'>
                    <a href={post.href}>
                ...
                <div className='mt-4 flex'>
                  <a
                    ...
                    className='relative flex gap-x-2.5 text-sm font-semibold leading-6 text-neutral-900'
                  >
                    <img
