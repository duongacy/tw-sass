      ...
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        <div className='mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2'>
          <div className='lg:pr-4'>
            <div className='relative overflow-hidden rounded-3xl bg-neutral-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10'>
              <img
                ...
                alt=''
              />
              <div className='absolute inset-0 bg-neutral-900 mix-blend-multiply' />
              <div
          ...
          <div>
            <div className='text-base leading-7 text-neutral-700 lg:max-w-lg'>
              ...
              <div className='max-w-xl'>
                <p className='mt-6'>
                  ...
                  id. Id dolor praesent donec est. Odio
                  penatibus risus viverra tellus varius sit
                  neque erat velit. Faucibus commodo massa
                  rhoncus, volutpat. Dignissim sed eget
                  risus enim. Mattis mauris semper sed amet
                  vitae sed turpis id.
                </p>
                <p className='mt-8'>
                  Et vitae blandit facilisi magna lacus
                  commodo. Vitae sapien duis odio id et. Id
                  blandit molestie auctor fermentum
                  dignissim. Lacus diam tincidunt ac cursus
                  in vel. Mauris varius vulputate et
                  ultrices hac adipiscing egestas. Iaculis
                  convallis ac tempor et ut. Ac lorem vel
                  integer orci.
                </p>
                <p className='mt-8'>
                  Et vitae blandit facilisi magna lacus
            ...
            <dl className='mt-10 grid grid-cols-2 gap-8 border-t border-neutral-900/10 pt-10 sm:grid-cols-4'>
              {stats.map((stat, statIdx) => (
                <div key={statIdx}>
                  <dt className='text-sm font-semibold leading-6 text-neutral-600'>
                    {stat.label}
                  </dt>
                  <dd className='mt-2 text-3xl font-bold leading-10 tracking-tight text-neutral-900'>
                    {stat.value}
                  </dd>
                </div>
              ))}
