...
export const ContentSection2: FC<ContentSectionProps> = ({
  ...
  return (
    <div
      className={`relative isolate overflow-hidden bg-white py-24 sm:py-32 ${className}`}
      {...props}
    >
      <div
      ...
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        ...
        <div className='mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:mt-10 lg:max-w-none lg:grid-cols-12'>
          <div className='relative lg:order-last lg:col-span-5'>
            <svg
              className='absolute -top-[40rem] left-1 -z-10 h-[64rem] w-[175.5rem] -translate-x-1/2 stroke-neutral-900/10 [mask-image:radial-gradient(64rem_64rem_at_111.5rem_0%,white,transparent)]'
              aria-hidden='true'
            >
              <defs>
                <pattern
            ...
            <figure className='border-l border-primary-600 pl-8'>
              <blockquote className='text-xl font-semibold leading-8 tracking-tight text-neutral-900'>
                <p>
                  “Vel ultricies morbi odio facilisi
                  ultrices accumsan donec lacus purus.
                  Lectus nibh ullamcorper ac dictum justo in
                  euismod. Risus aenean ut elit massa. In
              ...
              <figcaption className='mt-8 flex gap-x-4'>
                <img
                  ...
                  alt=''
                  className='mt-1 h-10 w-10 flex-none rounded-full bg-neutral-50'
                />
          ...
          <div className='max-w-xl text-base leading-7 text-neutral-700 lg:col-span-7'>
            <p>
              Faucibus commodo massa rhoncus, volutpat.
              Dignissim sed eget risus enim. Mattis mauris
              semper sed amet vitae sed turpis id. Id dolor
              praesent donec est. Odio penatibus risus
            ...
            <ul
              role='list'
              className='mt-8 max-w-xl space-y-8 text-neutral-600'
            >
            ...
            <p className='mt-8'>
              ...
              molestie auctor fermentum dignissim. Lacus
              diam tincidunt ac cursus in vel. Mauris varius
              vulputate et ultrices hac adipiscing egestas.
              Iaculis convallis ac tempor et ut. Ac lorem
              vel integer orci.
            </p>
            ...
            <p className='mt-6'>
              ...
              mauris, ultrices mauris. Tincidunt enim cursus
              ridiculus mi. Pellentesque nam sed nullam sed
