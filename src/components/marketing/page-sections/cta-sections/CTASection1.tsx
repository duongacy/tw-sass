...
export const CTASection1: FC<CTASectionProps> = ({
  className,
  ...props
}) => {
  return (
    <div className={`bg-white ${className}`} {...props}>
      <div className='mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8'>
        <div className='relative isolate overflow-hidden bg-neutral-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0'>
          <svg
