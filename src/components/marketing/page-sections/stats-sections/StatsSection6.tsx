...
export const StatsSection6: FC<StatsSectionProps> = ({
  ...
  return (
    ...
    >
      <img
        className='h-56 w-full bg-neutral-50 object-cover lg:absolute lg:inset-y-0 lg:left-0 lg:h-full lg:w-1/2'
          ...
          <div className='mx-auto max-w-2xl lg:mr-0 lg:max-w-lg'>
            ...
            <dl className='mt-16 grid max-w-xl grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 xl:mt-16'>
              {stats.map((stat) => (
                <div
                  key={stat.id}
                  className='flex flex-col gap-y-3 border-l border-neutral-900/10 pl-6'
                >
                  <dt className='text-sm leading-6 text-neutral-600'>
                    {stat.name}
                  </dt>
