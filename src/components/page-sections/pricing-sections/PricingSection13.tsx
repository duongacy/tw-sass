...
export const PricingSection13: FC<PricingSectionProps> = ({
  className = '',
  ...props
}) => {
  return (
        ...
        {tiers.map((tier, tierIdx) => (
          <div
            ...
            className={classNames(
              tier.featured ? 'relative bg-neutral-900 shadow-2xl' : 'bg-white/60 sm:mx-8 lg:mx-0',
              tier.featured
                ? ''
                : tierIdx === 0
          ...
          >
            ...
            <p className="mt-4 flex items-baseline gap-x-2">
              ...
              <span className={classNames(tier.featured ? 'text-neutral-400' : 'text-neutral-500', 'text-base')}>/month</span>
            </p>
            <p className={classNames(tier.featured ? 'text-neutral-300' : 'text-neutral-600', 'mt-6 text-base leading-7')}>
              {tier.description}
            </p>
            <ul
              role="list"
