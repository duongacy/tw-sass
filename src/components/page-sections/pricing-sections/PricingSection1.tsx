...
export const PricingSection1: FC<PricingSectionProps> = ({
  className='',
  ...props
}) => {
  return (
    <div className={"bg-white py-24 sm:py-32 " + className} {...props}>
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="text-3xl font-bold tracking-tight text-neutral-900 sm:text-4xl">Simple no-tricks pricing</h2>
        ...
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-neutral-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            <h3 className="text-2xl font-bold tracking-tight text-neutral-900">Lifetime membership</h3>
          ...
          <div className="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
            <div className="rounded-2xl bg-neutral-50 py-10 text-center ring-1 ring-inset ring-neutral-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
              <div className="mx-auto max-w-xs px-8">
                <p className="text-base font-semibold text-neutral-600">Pay once, own it forever</p>
                <p className="mt-6 flex items-baseline justify-center gap-x-2">
                  <span className="text-5xl font-bold tracking-tight text-neutral-900">$349</span>
                  <span className="text-sm font-semibold leading-6 tracking-wide text-neutral-600">USD</span>
                </p>
                <a
                  href="#"
