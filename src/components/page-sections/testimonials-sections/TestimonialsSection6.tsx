            ...
            <figure className='mt-10 flex flex-auto flex-col justify-between'>
              <blockquote className='text-lg leading-8 text-white'>
                <p>
                  ...
                  praesent at a. Ornare arcu gravida natoque
                  erat et cursus tortor consequat at.
              ...
              <figcaption className='mt-10 flex items-center gap-x-6'>
                <img
                  className='h-14 w-14 rounded-full bg-neutral-800'
            ...
            <figure className='mt-10 flex flex-auto flex-col justify-between'>
              <blockquote className='text-lg leading-8 text-white'>
                <p>
                  ...
                  exercitation elit. Nostrud veniam sint
                  dolor nisi ullamco.”
                </p>
              </blockquote>
              <figcaption className='mt-10 flex items-center gap-x-6'>
