  ...
  return (
    ...
    >
      ...
      <div className='mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32'>
        ...
        <div className='mt-16 border-t border-neutral-900/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between'>
          ...
          <form className='mt-6 sm:flex sm:max-w-md lg:mt-0'>
            ...
            <input
              ...
              autoComplete='email'
              required
              className='w-full min-w-0 appearance-none rounded-md border-0 bg-white px-3 py-1.5 text-base text-neutral-900 shadow-sm ring-1 ring-inset ring-neutral-300 placeholder:text-neutral-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:w-56 sm:text-sm sm:leading-6'
        ...
        <div className='mt-8 border-t border-neutral-900/10 pt-8 md:flex md:items-center md:justify-between'>
