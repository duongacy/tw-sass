  ...
  return (
    ...
    >
      <div className='lg:absolute lg:inset-0 lg:left-1/2'>
        <img
          className='h-64 w-full bg-neutral-50 object-cover sm:h-80 lg:absolute lg:h-full'
            ...
            >
              <div className='grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2'>
                ...
                <fieldset className='sm:col-span-2'>
                  <legend className='block text-sm font-semibold leading-6 text-neutral-900'>
                    Expected budget
                  </legend>
                  <div className='mt-4 space-y-4 text-sm leading-6 text-neutral-600'>
                    <div className='flex gap-x-2.5'>
                      <input
                        ...
                        type='radio'
                        className='mt-1 h-4 w-4 border-neutral-300 text-primary-600 shadow-sm focus:ring-primary-600'
                      />
              ...
              <div className='mt-10 flex justify-end border-t border-neutral-900/10 pt-8'>
                <button
                  type='submit'
