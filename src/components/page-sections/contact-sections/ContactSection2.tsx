        ...
        <div className='mx-auto max-w-2xl space-y-16 divide-y divide-neutral-100 lg:mx-0 lg:max-w-none'>
          ...
          <div className='grid grid-cols-1 gap-x-8 gap-y-10 pt-16 lg:grid-cols-3'>
            <div>
              ...
              <p className='mt-4 leading-7 text-neutral-600'>
                Consequat sunt cillum cillum elit sint. Qui
                occaecat nisi in ipsum commodo.
              </p>
            </div>
            <div className='grid grid-cols-1 gap-6 sm:grid-cols-2 lg:col-span-2 lg:gap-8'>
              <div className='rounded-2xl bg-neutral-50 p-10'>
                ...
                <address className='mt-3 space-y-1 text-sm not-italic leading-6 text-neutral-600'>
