...
export const ContactSection4: FC<ContactSectionProps> = ({
  ...
  return (
    <div
      className={`relative isolate bg-neutral-900 ${className}`}
      {...props}
    >
        ...
        <div className='relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48'>
          <div className='mx-auto max-w-xl lg:mx-0 lg:max-w-lg'>
            <div className='absolute inset-y-0 left-0 -z-10 w-full overflow-hidden ring-1 ring-white/5 lg:w-1/2'>
              <svg
                className='absolute inset-0 h-full w-full stroke-neutral-700 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]'
                aria-hidden='true'
              >
                <defs>
                  <pattern
                ...
                <svg
                  x='100%'
                  y={-1}
                  className='overflow-visible fill-neutral-800/20'
                >
                  <path
            ...
            <dl className='mt-10 space-y-4 text-base leading-7 text-neutral-300'>
