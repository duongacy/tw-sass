      ...
      <div className='mx-auto mt-20 max-w-lg space-y-16'>
        <div className='flex gap-x-6'>
          ...
          <div>
            ...
            <p className='mt-2 leading-7 text-neutral-600'>
              Ut cursus est ut amet. Lobortis eget egestas
              leo vitae eget porttitor risus blandit. Nunc a
              in lorem vel iaculis porttitor.
            </p>
            <p className='mt-4'>
              <a
                href='#'
        ...
        <div className='flex gap-x-6'>
          ...
          <div>
            ...
            <p className='mt-2 leading-7 text-neutral-600'>
              Expedita qui non ut quia ipsum voluptatum
              ipsam pariatur. Culpa vitae ipsum minus eius
              vero quo quibusdam.
            </p>
            <p className='mt-4'>
              <a
        ...
        <div className='flex gap-x-6'>
          ...
          <div>
            ...
            <p className='mt-2 leading-7 text-neutral-600'>
              Sint aut modi porro consequatur architecto
              commodi qui consequatur. Dignissimos adipisci
              minima.
            </p>
            <p className='mt-4'>
              <a
