...
export const StatsSection9: FC<StatsSectionProps> = ({
  className,
  ...props
}) => {
  return (
    ...
    >
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        <div className='mx-auto max-w-2xl lg:mx-0 lg:max-w-none'>
          <p className='text-primary-400 text-base font-semibold leading-7'>
            Deploy faster
          </p>
          <h1 className='mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl'>
            A better workflow
          </h1>
          <div className='text-neutral-300 mt-10 grid max-w-xl grid-cols-1 gap-8 text-base leading-7 lg:max-w-none lg:grid-cols-2'>
            <div>
              <p>
            ...
            <div>
              <p>
                ...
                nulla ultrices congue nunc tortor. Enim et
          ...
          <dl className='mt-16 grid grid-cols-1 gap-x-8 gap-y-12 sm:mt-20 sm:grid-cols-2 sm:gap-y-16 lg:mt-28 lg:grid-cols-4'>
            {stats.map((stat, statIdx) => (
              ...
              >
                <dt className='text-neutral-300 text-base leading-7'>
                  {stat.label}
                </dt>
