...
export const FeatureSection1: FC<FeatureSectionProps> = ({
  className,
  ...props
}) => {
  return (
    <div
      className={`overflow-hidden bg-bgc-0 py-24 sm:py-32 ${className}`}
      {...props}
    >
        ...
        <div className='mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2'>
          <div className='lg:pr-8 lg:pt-4'>
            <div className='lg:max-w-lg'>
              ...
              <dl className='mt-10 max-w-xl space-y-8 text-base leading-7 text-accent-300 lg:max-w-none'>
          ...
          <img
            ...
            className='w-[48rem] max-w-none rounded-xl shadow-xl ring-1 ring-accent-400/10 sm:w-[57rem] md:-ml-4 lg:-ml-0'
            width={2432}
            height={1442}
          />
        </div>
