...
export const FeatureSection4: FC<FeatureSectionProps> = ({
  className,
  ...props
}) => {
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-neutral-900 sm:text-4xl">No server? No problem.</p>
