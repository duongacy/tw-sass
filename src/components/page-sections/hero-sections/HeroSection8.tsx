      ...
      <div className='relative isolate pt-14'>
        ...
        <div className='mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40'>
          <div className='mx-auto max-w-2xl lg:mx-0 lg:flex-auto'>
            ...
            <h1 className='mt-10 max-w-lg text-4xl font-bold tracking-tight text-neutral-900 sm:text-6xl'>
              A better way to ship your projects
            </h1>
            <p className='mt-6 text-lg leading-8 text-neutral-600'>
              Esse id magna consectetur fugiat non dolor in
              ad laboris magna laborum ea consequat. Nisi
              irure aliquip nisi adipisicing veniam
              voluptate id. In veniam incididunt ex veniam
              adipisicing sit.
            </p>
